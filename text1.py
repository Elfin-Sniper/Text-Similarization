...
# Compute Similarity
lambda_layer = Lambda(lambda tensors: tf.abs(tensors[0] - tensors[1]), output_shape=(50,))
...
# **Fixed model training with correct data**
history = model.fit(
...
model.save("model/text_similarity_model.h5")
